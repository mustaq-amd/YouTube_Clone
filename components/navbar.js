...
function yt_clone_navbar(){

    return `<div id="yt-nav">
    <div class="yt-nav-sec1">
      <div class="yt-home-icon">
        <div
          ...
          <div class="offcanvas-header">
            <div class="yt-nav-sec1">
              ...
              <div class="yt-logo">
                ...
                <span id="country-code" class="cc">IN</span>
              </div>
            </div>
          </div>
        ...
        <button
          ...
          style="border: none; background-color: white; margin-top: 3px"
        >
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
    ...
    <div class="yt-nav-sec2">
      <div class="yt-home-search">
        <input type="text" placeholder="Search" id="yt-seacrh" />
        <button id="searchVideos-yt">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
    ...
    <div class="yt-nav-sec3">
      <div class="yt-nav-rt-icon ic-1">
        <svg
          viewBox="0 0 24 24"
          preserveAspectRatio="xMidYMid meet"
          focusable="false"
      ...
      <div class="yt-nav-rt-icon ic-4">
        <img
          ...
          height="32"
          width="32"
          src="https://yt3.ggpht.com/yti/APfAmoFdfh3FOjBfDa9cuchLbepb9s2XxBHL4AgsrtgRICs=s88-c-k-c0x00ffffff-no-rj-mo"
        />
      </div>
    </div>
  </div>`;
...
export default yt_clone_navbar;